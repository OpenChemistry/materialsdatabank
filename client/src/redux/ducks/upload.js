...
export const upload = createAction(UPLOAD,
    (title, authors, url, slug,  structureFile, reconstructionFile, imageFile, resolve, reject) => ({ title,
      authors, slug, url,  structureFile, reconstructionFile, imageFile, resolve, reject}));
